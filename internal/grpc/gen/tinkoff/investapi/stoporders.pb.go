...
// UnimplementedStopOrdersServiceServer can be embedded to have forward compatible implementations.
...
func RegisterStopOrdersServiceServer(s *grpc.Server, srv StopOrdersServiceServer) {
	s.RegisterService(&_StopOrdersService_serviceDesc, srv)
}
...
var _StopOrdersService_serviceDesc = grpc.ServiceDesc{
