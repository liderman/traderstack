...
func (c *ordersStreamServiceClient) TradesStream(ctx context.Context, in *TradesStreamRequest, opts ...grpc.CallOption) (OrdersStreamService_TradesStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OrdersStreamService_serviceDesc.Streams[0], "/tinkoff.public.invest.api.contract.v1.OrdersStreamService/TradesStream", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedOrdersStreamServiceServer can be embedded to have forward compatible implementations.
...
func RegisterOrdersStreamServiceServer(s *grpc.Server, srv OrdersStreamServiceServer) {
	s.RegisterService(&_OrdersStreamService_serviceDesc, srv)
}
...
var _OrdersStreamService_serviceDesc = grpc.ServiceDesc{
